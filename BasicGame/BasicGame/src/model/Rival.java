...
public class Rival {
    ...
    public void moureEndavant(){
        vehicle.brake(0f);
        if (vehicle.getLinearVelocity().length()<20) {
            vehicle.accelerate(1000.0f);
        } else {
