...
public class MenuController {
    ...
    public MenuController(AppSettings settings,AppStateManager stateManager,AssetManager assetManager,Node rootNode,ViewPort guiViewPort,InputManager inputManager, AudioRenderer audioRenderer,SimpleApplication main,boolean debugInfo,int initNumEnemies,int minNumEnemies, int maxNumEnemies,int initNumLaps, int minNumLaps, int maxNumLaps,boolean music,boolean effects,int initCar,int initCarColor,int initClima,int initCircuit){
        //Añadimos el menu creado con nifty
        controller = new Menu(settings,assetManager,rootNode,main,debugInfo,initNumEnemies,minNumEnemies,maxNumEnemies,initNumLaps,minNumLaps,maxNumLaps,music,effects,initCar,initCarColor,initClima,initCircuit);
